...
cat <<EOF >> $targetFile
  {"name": "io.neo9.scaler.access.config.ScaleToZeroConfig", "allDeclaredMethods": true, "allPublicConstructors": true},
  {"name": "io.neo9.scaler.access.config.ScaleDownCronConfig", "allDeclaredMethods": true, "allPublicConstructors": true},
