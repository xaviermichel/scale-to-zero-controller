...
public class PodService {
    ...
    public String getLogsSince(Pod pod, int sinceMinutes, String exclusionRegex) {
        ...
        String logFiltered = completePodLog.lines().filter(line -> !Pattern.matches(exclusionRegex, line)).collect(Collectors.joining(NEW_LINE));
        return isEmpty(logFiltered) ? logFiltered : (logFiltered + NEW_LINE);
    }
}
